...
# Substrait Compliance Framework - TPC-DS Demo Runner
# This script validates the actual Java framework and runs the framework-backed TPC-DS demo

set -e  # Exit on error

echo "================================================================================"
echo "Substrait Compliance Framework - TPC-DS Demo (99 Queries)"
echo "================================================================================"
echo ""
...
if [ ! -f "README.md" ] || [ ! -d "runner" ]; then
    ...
    echo "   cd demo && ./runner/run-tpcds-demo.sh"
    exit 1
fi
...
javac -proc:none -cp "${DEMO_CLASSPATH}" -d build \
    ...
    runner/TPCDSDemoRunner.java

echo -e "${GREEN}✅ Demo classes compiled successfully${NC}"
echo ""

# Step 4: Run the framework-backed TPC-DS demo
echo -e "${BLUE}🚀 Step 4: Running framework-backed TPC-DS compliance demo (99 queries)...${NC}"
echo ""

java -Xmx8g -cp "build:${DEMO_CLASSPATH}" io.substrait.demo.runner.TPCDSDemoRunner
...
echo "================================================================================"
echo -e "${GREEN}🎉 TPC-DS Demo Complete!${NC}"
echo "================================================================================"
echo ""
echo "📁 Generated Files:"
echo "   • output/mockdb-tpcds-report.json"
echo "   • output/fastdb-tpcds-report.json"
echo "   • output/clouddb-tpcds-report.json"
echo "   • output/duckdb-tpcds-report.json"
echo "   • output/postgresql-tpcds-report.json"
echo "   • output/leaderboard-tpcds.json"
echo "   • dashboard/data/leaderboard-tpcds.json"
echo ""
echo "🌐 View Dashboard:"
...
echo ""
echo "📊 View Reports:"
echo "   cat output/leaderboard-tpcds.json"
echo "   cat output/mockdb-tpcds-report.json"
echo ""
echo "🔄 Run Again:"
echo "   ./runner/run-tpcds-demo.sh"
echo "   (validates the Java SDK and runs the TPC-DS compliance demo)"
echo ""
echo "📈 Compare with TPC-H:"
echo "   ./runner/run-simple-demo.sh"
echo "   (22 TPC-H queries)"
echo ""
echo "================================================================================"
