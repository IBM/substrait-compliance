/**
 * DuckDB Compliance Example - Main Entry Point
 * 
 * Demonstrates how to use the DuckDB compliance engine to run
...
std::map<std::string, TableData> createSampleData() {
    ...
    std::vector<std::string> columns = {"order_id", "customer_id", "amount"};
    std::vector<std::string> types = {"i32", "i32", "fp64"};
    std::vector<std::vector<Value>> rows = {
        {int64_t(1), int64_t(100), 150.50},
        {int64_t(2), int64_t(101), 200.75},
        {int64_t(3), int64_t(100), 99.99},
        {int64_t(4), int64_t(102), 450.00},
        {int64_t(5), int64_t(101), 325.25}
    };
    ...
    types = {"i32", "string", "string"};
    rows = {
        {int64_t(100), std::string("Alice"), std::string("USA")},
        {int64_t(101), std::string("Bob"), std::string("UK")},
        {int64_t(102), std::string("Charlie"), std::string("Canada")}
    };
...
int main(int argc, char* argv[]) {
    std::cout << "DuckDB Substrait Compliance Example\n";
    std::cout << "====================================\n\n";
